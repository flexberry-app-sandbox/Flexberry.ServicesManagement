...
moduleForAcceptance('[AGAT] Acceptance | i i s services management customer request l');

test('testing i-i-s-services-management-customer-request-l', function(assert) {
