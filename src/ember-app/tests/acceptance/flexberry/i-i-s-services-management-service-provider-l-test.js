...
moduleForAcceptance('[AGAT] Acceptance | i i s services management service provider l');

test('testing i-i-s-services-management-service-provider-l', function(assert) {
