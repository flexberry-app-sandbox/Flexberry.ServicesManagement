...
moduleForModel('i-i-s-services-management-ticket-position', 'Unit | Serializer | i-i-s-services-management-ticket-position', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-services-management-ticket-position',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
