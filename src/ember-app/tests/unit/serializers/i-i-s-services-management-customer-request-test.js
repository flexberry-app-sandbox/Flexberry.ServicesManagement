...
moduleForModel('i-i-s-services-management-customer-request', 'Unit | Serializer | i-i-s-services-management-customer-request', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-services-management-customer-request',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
