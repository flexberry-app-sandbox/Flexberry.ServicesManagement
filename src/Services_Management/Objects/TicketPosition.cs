...
namespace IIS.Services_Management
{
    ...
    public class TicketPosition : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Services_Management.Ticket fTicket;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Services_Management.Ticket.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.Services_Management.Ticket Ticket
        {
            get
            {
                ...
                IIS.Services_Management.Ticket result = this.fTicket;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View TicketPositionE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TicketPositionE", typeof(IIS.Services_Management.TicketPosition));
                }
            }
        }
    }
    ...
    public class DetailArrayOfTicketPosition : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Services_Management.DetailArrayOfTicketPosition members)

        // *** End programmer edit section *** (IIS.Services_Management.DetailArrayOfTicketPosition members)
        ...
        /// </summary>
        public DetailArrayOfTicketPosition(IIS.Services_Management.Ticket fTicket) : 
                base(typeof(TicketPosition), ((ICSSoft.STORMNET.DataObject)(fTicket)))
        {
        }
        
        public IIS.Services_Management.TicketPosition this[int index]
        {
            get
            {
                return ((IIS.Services_Management.TicketPosition)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Services_Management.TicketPosition dataobject)
        {
